  ...
  return (
    <>
      ...
      <div className="gap-10 flex  w-full h-full flex-col items-center rounded-xl bg-white lg:pt-16 pb-5 lg:w-[550px]">
        <p className="text-2xl font-medium md:text-3xl text-center">
          {t('title')}
        </p>
        <p className="mt-2  text-center text-xs font-normal text-[#817C74] md:text-sm ">
          {t('text')}
        </p>
        <form
          className=" px-4 lg:px-0 flex w-full flex-col items-center  max-w-md mx-auto "
        ...
        >
          ...
          <PasswordInput
            ...
            label={
              <p className="text-xs font-medium text-[#817C74]">
                {t('inputs.confirm_password.text')}
              </p>
            }
