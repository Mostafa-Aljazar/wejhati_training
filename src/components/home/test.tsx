...
export default function Search_Form() {
  ...
  return (
    <Fieldset
      ...
      radius={12}
      className="flex flex-col !bg-yellow-300 shadow-lg !mx-0 md:mt-0 !p-0 rounded-xl w-full lg:w-[950px] xl:w-[1140px] md:h-[250px] lg:h-[167px]"
    >
      <div className="flex flex-col justify-center items-center bg-green-500 mt-4 lg:-mt-2 w-full">
        <Tabs
          value={activeTab}
